        ...
        <div class="card-body">
            <form wire:submit="save">
                ...
                <div class="mb-3">
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($this->selectedCategory && $this->reports->isEmpty()): ?>
