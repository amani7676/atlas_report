    ...
    <div class="card">
        ...
        <div class="table-container">
            <table class="table">
                <thead>
                    <tr>
                        ...
                        <th wire:click="sortBy('blacklist_id')" style="cursor: pointer;">
                            کد 5 رقمی
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($sortBy === 'blacklist_id'): ?>
                                <i class="fas fa-sort-<?php echo e($sortDirection === 'asc' ? 'up' : 'down'); ?>"></i>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        </th>
                        <th>توضیحات</th>
                ...
                <tbody>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $blacklists; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $blacklist): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr>
                            <td>
                                <strong><?php echo e($blacklist->title); ?></strong>
                            </td>
                            <td>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($blacklist->blacklist_id): ?>
                                    <span style="background: #28a745; color: white; padding: 4px 8px; border-radius: 4px; font-weight: bold;">
                                        <?php echo e($blacklist->blacklist_id); ?>
                            ...
                            <td>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($blacklist->description): ?>
                                    <p style="color: #666; font-size: 14px; margin: 0;">
                                        <?php echo e(Str::limit($blacklist->description, 50)); ?>
                            ...
                            <td>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($blacklist->is_active): ?>
                            ...
                            <td>
                                <?php echo e(jalaliDate($blacklist->created_at, 'Y/m/d H:i')); ?>

                            </td>
                            <td>
                                <div style="display: flex; gap: 5px; align-items: center;">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($blacklist->api_response): ?>
                                        <button 
                                            wire:click="showApiResponse(<?php echo e($blacklist->id); ?>)" 
                                            class="btn" 
                                    ...
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    <button 
                                        wire:click="toggleActive(<?php echo e($blacklist->id); ?>)" 
                                        class="btn" 
                                        style="background: <?php echo e($blacklist->is_active ? '#ffc107' : '#28a745'); ?>; color: white; padding: 5px 10px; font-size: 12px;"
                                        title="<?php echo e($blacklist->is_active ? 'غیرفعال کردن' : 'فعال کردن'); ?>"
                                    >
                                        <i class="fas fa-<?php echo e($blacklist->is_active ? 'pause' : 'play'); ?>"></i>
                                    </button>
                                    <button 
                                        wire:click="openEditModal(<?php echo e($blacklist->id); ?>)" 
                                        class="btn" 
                                    ...
                                    <button 
                                        onclick="confirmDeleteBlacklist(<?php echo e($blacklist->id); ?>, '<?php echo e($blacklist->title); ?>')" 
        ...
        <!-- Pagination -->
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($blacklists->hasPages()): ?>
            <div style="margin-top: 20px; display: flex; justify-content: center;">
                <?php echo e($blacklists->links('pagination::bootstrap-4')); ?>
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($showModal): ?>
        <div style="position: fixed; top: 0; right: 0; bottom: 0; left: 0; background: rgba(0,0,0,0.5); z-index: 1000; display: flex; align-items: center; justify-content: center; padding: 20px;">
            <div style="background: white; border-radius: 10px; width: 100%; max-width: 600px; max-height: 90vh; overflow-y: auto; padding: 30px;">
                <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 20px;">
                    <h3><?php echo e($isEditing ? 'ویرایش لیست سیاه' : 'ایجاد لیست سیاه جدید'); ?></h3>
                    <button wire:click="closeModal" style="background: none; border: none; font-size: 24px; cursor: pointer; color: #999;">
                        <i class="fas fa-times"></i>
                    </button>
                </div>

                <form wire:submit.prevent="<?php echo e($isEditing ? 'updateBlacklist' : 'createBlacklist'); ?>">
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    ...
                    <div style="display: flex; gap: 10px; justify-content: flex-end; margin-top: 20px;">
                        ...
                        <button type="submit" class="btn btn-primary">
                            <?php echo e($isEditing ? 'ذخیره تغییرات' : 'ایجاد لیست سیاه'); ?>
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($showApiResponseModal && $apiResponseData): ?>
        <div style="position: fixed; top: 0; right: 0; bottom: 0; left: 0; background: rgba(0,0,0,0.5); z-index: 1000; display: flex; align-items: center; justify-content: center; padding: 20px;">
            <div style="background: white; border-radius: 10px; width: 100%; max-width: 800px; max-height: 90vh; overflow-y: auto; padding: 30px;">
                <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 20px;">
                    <h3>پاسخ API - <?php echo e($apiResponseData['title']); ?></h3>
                ...
                <div style="background: #f8f9fa; padding: 20px; border-radius: 6px; margin-bottom: 15px;">
                    <div style="margin-bottom: 10px;">
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($apiResponseData['blacklist_id']): ?>
                            <span style="background: #28a745; color: white; padding: 4px 8px; border-radius: 4px; font-weight: bold;">
                                <?php echo e($apiResponseData['blacklist_id']); ?>
        ...
        function confirmDeleteBlacklist(id, title) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    window.Livewire.find('<?php echo e($_instance->getId()); ?>').deleteBlacklist(id);
                }
            });
        }
    </script>
</div>
<?php /**PATH C:\laragon\www\atlas_report\resources\views\livewire\blacklists\index.blade.php ENDPATH**/ ?>