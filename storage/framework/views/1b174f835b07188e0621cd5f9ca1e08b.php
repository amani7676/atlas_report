                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($selectedPatterns)): ?>
                        <div class="form-group">
                            ...
                            <div style="background: #f8f9fa; padding: 15px; border-radius: 6px;">
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($allVariableCodes)): ?>
                                    <div style="margin-top: 15px; padding: 15px; background: white; border-radius: 6px; border: 1px solid #dee2e6;">
                                        ...
                                        <div style="margin-bottom: 10px;">
                                            ...
                                            <div style="display: flex; flex-wrap: wrap; gap: 5px; margin-top: 5px;">
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $allVariableCodes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $variableCode): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $allVariableCodes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $variableCode): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div style="margin-bottom: 10px;">
                                                ...
                                                <select 
                                                    wire:model="variableAssignments.<?php echo e($variableCode); ?>" 
                                                ...
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['variableAssignments.' . $variableCode];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
