                    ...
                    <div class="card-body">
                        ...
                        <form wire:submit="saveThresholds">
                            <div class="mb-4">
                                ...
                                <input 
                                    type="number" 
                                    class="form-control <?php $__errorArgs = ['yellowThreshold'];
...
$message = $__bag->first($__errorArgs[0]); ?> ? 'is-invalid' : ''" 
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['yellowThreshold'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            ...
                            <div class="mb-4">
                                ...
                                <input 
                                    type="number" 
                                    class="form-control <?php $__errorArgs = ['redThreshold'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> ? 'is-invalid' : ''" 
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['redThreshold'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
<?php $__env->stopPush(); ?>
<?php /**PATH C:\laragon\www\atlas_report\resources\views\livewire\admin\card-thresholds.blade.php ENDPATH**/ ?>