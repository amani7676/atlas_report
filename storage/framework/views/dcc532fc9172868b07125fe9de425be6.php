<div>
    <?php $__env->startSection('title', 'ارسال گروهی پیامک'); ?>
    ...
    <div class="container-fluid py-3">
        ...
        <ul class="nav nav-tabs mb-3" role="tablist" style="border-bottom: 2px solid #dee2e6;">
            <li class="nav-item" role="presentation">
                <a class="nav-link <?php echo e(request()->is('residents/group-sms') ? 'active' : ''); ?>" 
                   href="/residents/group-sms"
                   style="color: <?php echo e(request()->is('residents/group-sms') ? '#0d6efd' : '#6c757d'); ?>; border-bottom: <?php echo e(request()->is('residents/group-sms') ? '2px solid #0d6efd' : 'none'); ?>; padding: 12px 20px; font-weight: <?php echo e(request()->is('residents/group-sms') ? '600' : '400'); ?>;">
                    <i class="fas fa-paper-plane me-2"></i>
                    ارسال گروهی پیامک
                </a>
            </li>
            <li class="nav-item" role="presentation">
                <a class="nav-link <?php echo e(request()->is('sms/sent') ? 'active' : ''); ?>" 
                   href="/sms/sent"
                   style="color: <?php echo e(request()->is('sms/sent') ? '#0d6efd' : '#6c757d'); ?>; border-bottom: <?php echo e(request()->is('sms/sent') ? '2px solid #0d6efd' : 'none'); ?>; padding: 12px 20px; font-weight: <?php echo e(request()->is('sms/sent') ? '600' : '400'); ?>;">
                ...
                <div class="d-flex flex-column flex-md-row gap-2">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($selectedCount > 0): ?>
                        <span class="badge bg-warning text-dark">
                            ...
                            <?php echo e($selectedCount); ?> مورد انتخاب شده
                        </span>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($filteredCount)): ?>
                        <span class="badge bg-info">
                            <i class="fas fa-users me-1"></i>
                            <?php echo e($filteredCount); ?> اقامت‌گر فیلتر شده
                        </span>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                </div>
            </div>
    ...
    <div class="mdc-card fade-in">
        ...
        <div style="display: flex; gap: 12px; margin-bottom: 20px; flex-wrap: wrap;">
            <button 
                ...
                wire:click="$set('showFilters', <?php echo e(!$showFilters); ?>)"
            >
                <i class="fas fa-<?php echo e($showFilters ? 'eye-slash' : 'filter'); ?>"></i>
                <?php echo e($showFilters ? 'مخفی کردن فیلترها' : 'نمایش فیلترها'); ?>

            </button>
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(count(array_filter($filters))): ?>
                ...
                <div style="display: grid; grid-template-columns: repeat(auto-fill, minmax(250px, 1fr)); gap: 16px;">
                    ...
                    <div class="mdc-select">
                        <select class="mdc-select__native-control" wire:model.live="filters.unit_name">
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $unitsList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $unit): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div class="mdc-select">
                        <select class="mdc-select__native-control" wire:model.live="filters.room_name">
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $roomsList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $room): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div class="mdc-select">
                        <select class="mdc-select__native-control" wire:model.live="filters.bed_name">
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $bedsList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bed): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($bed); ?>"><?php echo e($bed); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        </select>
            ...
            <table class="mdc-data-table">
                ...
                <tbody>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $residents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $resident): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="mdc-data-table__row <?php echo e(in_array($resident->id, $selectedResidents) ? 'mdc-data-table__row--selected' : ''); ?>">
                            <td class="mdc-data-table__cell">
                                <input 
                                    type="checkbox" 
                                    value="<?php echo e($resident->id); ?>"
                                    wire:click="toggleSelectResident(<?php echo e($resident->id); ?>)"
                                    <?php echo e(in_array($resident->id, $selectedResidents) ? 'checked' : ''); ?>

                                    style="cursor: pointer; width: 18px; height: 18px;"
                                >
                            </td>
                            <td class="mdc-data-table__cell"><?php echo e($residents->firstItem() + $index); ?></td>
                            <td class="mdc-data-table__cell">
                                <strong style="color: var(--mdc-on-surface);"><?php echo e($resident->resident_full_name ?? 'نامشخص'); ?></strong>
                            </td>
                            <td class="mdc-data-table__cell"><?php echo e($resident->resident_phone ?? '-'); ?></td>
                            <td class="mdc-data-table__cell"><?php echo e($resident->unit_name ?? '-'); ?></td>
                            <td class="mdc-data-table__cell"><?php echo e($resident->room_name ?? '-'); ?></td>
                            <td class="mdc-data-table__cell"><?php echo e($resident->bed_name ?? '-'); ?></td>
                            <td class="mdc-data-table__cell">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($resident->resident_document): ?>
                            ...
                            <td class="mdc-data-table__cell">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($resident->resident_form): ?>
                                    <span class="mdc-chip mdc-chip--success">دارد</span>
                                <?php else: ?>
                                    <span class="mdc-chip">ندارد</span>
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            ...
                            <td class="mdc-data-table__cell">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($resident->contract_state === 'active'): ?>
                            ...
                            <td class="mdc-data-table__cell">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($resident->contract_payment_date_jalali): ?>
                                    <span class="mdc-chip mdc-chip--info">
                                        <?php echo e($resident->contract_payment_date_jalali); ?>
                            ...
                            <td class="mdc-data-table__cell">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($resident->resident_deleted_at): ?>
        ...
        <div class="mdc-card fade-in" style="margin-top: 24px;">
            ...
            <div style="display: grid; grid-template-columns: repeat(auto-fill, minmax(300px, 1fr)); gap: 16px; margin-bottom: 20px;">
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($availableSenderNumbers->count() > 0): ?>
                    <div class="mdc-select">
                        <select class="mdc-select__native-control" wire:model.live="selectedSenderNumberId">
                            <option value="">شماره فرستنده پیش‌فرض</option>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $availableSenderNumbers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $senderNumber): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($senderNumber->id); ?>"><?php echo e($senderNumber->number); ?> - <?php echo e($senderNumber->name ?? 'بدون نام'); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        </select>
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($selectedPatternObj): ?>
                    <div style="background: #f8f9fa; padding: 16px; border-radius: 8px; margin-bottom: 16px; border-right: 4px solid var(--mdc-primary);">
                        <div style="display: flex; justify-content: space-between; align-items: start; margin-bottom: 8px;">
                            <strong style="color: var(--mdc-primary);"><?php echo e($selectedPatternObj->title); ?></strong>
                        </div>
                        <div style="color: rgba(0,0,0,0.7); font-size: 13px; line-height: 1.6;">
                            <?php echo e($selectedPatternObj->text); ?>
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($isSending): ?>
                <div style="background: #f8f9fa; padding: 16px; border-radius: 8px; margin-bottom: 16px;">
                    ...
                    <div style="background: #e0e0e0; height: 8px; border-radius: 4px; overflow: hidden;">
                        <div style="background: var(--mdc-primary); height: 100%; width: <?php echo e($sendingProgress['total'] > 0 ? (($sendingProgress['sent'] + $sendingProgress['failed']) / $sendingProgress['total'] * 100) : 0); ?>%; transition: width 0.3s;"></div>
                    </div>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($sendingProgress['current']): ?>
                        <div style="margin-top: 8px; font-size: 12px; color: rgba(0,0,0,0.6);">
                            در حال ارسال به: <strong><?php echo e($sendingProgress['current']); ?></strong>
                        </div>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    <div style="margin-top: 8px; display: flex; gap: 16px; font-size: 12px;">
                        <span style="color: var(--mdc-success);">
                            <i class="fas fa-check-circle"></i> موفق: <?php echo e($sendingProgress['sent']); ?>

                        </span>
                        <span style="color: var(--mdc-error);">
                            <i class="fas fa-times-circle"></i> ناموفق: <?php echo e($sendingProgress['failed']); ?>
            ...
            <div class="stats-bar fade-in" style="margin-top: 20px;">
                <div class="stats-bar__text">
                    ...
                    <strong><?php echo e($selectedCount); ?></strong> اقامت‌گر انتخاب شده
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($selectedPattern && $selectedCount > 0): ?>
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($selectedPattern): ?>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($selectedCount > 0): ?>
                            <button 
                                ...
                                <?php if($isSending): ?> disabled <?php endif; ?>
                            >
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($sendResults)): ?>
                    <div class="mt-3">
                        <h6 class="mb-2">
                        ...
                        <div style="max-height: 400px; overflow-y: auto; border: 1px solid #dee2e6; border-radius: 5px; padding: 10px;">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $sendResults; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $result): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="mb-3 p-3" style="background: <?php echo e($result['success'] ? '#f0f9ff' : '#fff3cd'); ?>; border-radius: 5px; border-right: 3px solid <?php echo e($result['success'] ? '#28a745' : '#f72585'); ?>;">
                                <div class="d-flex justify-content-between align-items-start mb-2">
                                    <strong style="color: <?php echo e($result['success'] ? '#28a745' : '#f72585'); ?>;">
                                        <?php echo e($index + 1); ?>. <?php echo e($result['resident_name']); ?> (<?php echo e($result['phone']); ?>)
                                    </strong>
                                    <span class="badge <?php echo e($result['success'] ? 'bg-success' : 'bg-danger'); ?>">
                                        <?php echo e($result['success'] ? '✓ موفق' : '✗ خطا'); ?>
                                ...
                                <div class="mb-2">
                                    <strong>پیام:</strong> 
                                    <span style="color: <?php echo e($result['success'] ? '#28a745' : '#f72585'); ?>;">
                                        <?php echo e($result['message'] ?? 'بدون پیام'); ?>
                                ...
                                <div class="mb-2">
                                    ...
                                    <code><?php echo e($result['response_code']); ?></code>
                                </div>
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                ...
                                <div class="mb-2">
                                    <strong>RecId:</strong> 
                                    <code><?php echo e($result['rec_id']); ?></code>
                                </div>
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                ...
                                <div class="mb-2">
                                    ...
                                    <pre style="background: #f8f9fa; padding: 8px; border-radius: 3px; font-size: 11px; margin-top: 5px; overflow-x: auto;"><?php echo e(is_array($result['api_response']) ? json_encode($result['api_response'], JSON_PRETTY_PRINT | JSON_UNESCAPED_UNICODE) : $result['api_response']); ?></pre>
                                </div>
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                ...
                                <div class="mb-2">
                                    ...
                                    <pre style="background: #f8f9fa; padding: 8px; border-radius: 3px; font-size: 11px; margin-top: 5px; overflow-x: auto; max-height: 150px; overflow-y: auto;"><?php echo e(is_array($result['raw_response']) ? json_encode($result['raw_response'], JSON_PRETTY_PRINT | JSON_UNESCAPED_UNICODE) : $result['raw_response']); ?></pre>
                                </div>
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($result['full_result'])): ?>
                                <details class="mt-2">
                                    <summary style="cursor: pointer; color: #0066cc; font-weight: bold;">
                                        <i class="fas fa-chevron-down me-1"></i>
                                        نمایش تمام اطلاعات نتیجه
                                    </summary>
                                    <pre style="background: #f8f9fa; padding: 8px; border-radius: 3px; font-size: 11px; margin-top: 5px; overflow-x: auto; max-height: 200px; overflow-y: auto;"><?php echo e(json_encode($result['full_result'], JSON_PRETTY_PRINT | JSON_UNESCAPED_UNICODE)); ?></pre>
                                </details>
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
...
<?php /**PATH C:\laragon\www\atlas_report\resources\views\livewire\residents\group-sms.blade.php ENDPATH**/ ?>