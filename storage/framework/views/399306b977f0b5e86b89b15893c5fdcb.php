<?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($showTimer): ?>
    ...
    <script>
        document.addEventListener('livewire:init', () => {
            const refreshInterval = <?php echo e($refreshInterval); ?>;
            let initialTimeRemaining = <?php echo e($initialTimeRemaining); ?>;
            ...
            function syncTimeFromServer() {
                ...
                window.Livewire.find('<?php echo e($_instance->getId()); ?>').call('getTimeRemaining').then((remaining) => {
            ...
            function updateTimer() {
                ...
                if (timeRemaining > 0) {
                    ...
                    window.Livewire.find('<?php echo e($_instance->getId()); ?>').call('performSync').then(() => {
...
<?php /**PATH C:\laragon\www\atlas_report\resources\views\livewire\layout\auto-sync-timer.blade.php ENDPATH**/ ?>